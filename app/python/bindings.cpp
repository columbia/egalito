...
BOOST_PYTHON_MODULE(python_egalito)
{
	...
	class_<Symbol>("Symbol", init<address_t, size_t, const char *, Symbol::SymbolType, Symbol::BindingType, size_t, size_t>())
	...
	class_<ChunkFind2>("ChunkFind2", init<Conductor *>())
		.def("findFunction", &ChunkFind2::findFunction, arg("module")=NULL, return_value_policy<manage_new_object>());
