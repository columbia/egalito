...
EGALITO_DEBLOAT=1 EGALITO_USE_GS=1 EGALITO_USE_SHUFFLING=1 \
../../src/loader ../binary/target/nginx/nginx/sbin/nginx -c ../conf-aio/nginx.conf >tmp/nginx-thread-jitshuffle.out 2>& 1 &
